...
Load< BasicMaterialForwardProgram > basic_material_forward_program(LoadTagEarly, []() -> BasicMaterialForwardProgram const * {
	...
	basic_material_forward_program_pipeline.CLIP_FROM_OBJECT_mat4 = ret->OBJECT_TO_CLIP_mat4;
	basic_material_forward_program_pipeline.LIGHT_FROM_OBJECT_mat4x3 = ret->OBJECT_TO_LIGHT_mat4x3;
	basic_material_forward_program_pipeline.LIGHT_FROM_NORMAL_mat3 = ret->NORMAL_TO_LIGHT_mat3;
...
BasicMaterialForwardProgram::BasicMaterialForwardProgram() {
	...
	glUniform1f(ROUGHNESS_float, 0.5f);
