...
Load<Sprite> tex_obstacle(LoadTagDefault, []() -> Sprite const *
                          { return load_texture_from_png(data_path("resource/textures/rock_material_basecolor_2.png"), true, true); });

Load<Sprite> tex_radar_blurred(LoadTagDefault, []() -> Sprite const *
                               { return load_texture_from_png(data_path("resource/textures/radar_spot.png"), true, false); });

Load<Sprite> tex_radar_submarine(LoadTagDefault, []() -> Sprite const *
                                 { return load_texture_from_png(data_path("resource/textures/submarine_icon.png"), false, false); });

Load<Sprite> tex_radar_flag(LoadTagDefault, []() -> Sprite const *
                            { return load_texture_from_png(data_path("resource/textures/flag_icon.png"), false, false); });

Load<Sprite> tex_radar_radar(LoadTagDefault, []() -> Sprite const *
                             { return load_texture_from_png(data_path("resource/textures/radar_icon.png"), false, false); });

Load<Sprite> tex_radar_submit_point(LoadTagDefault, []() -> Sprite const *
                                    { return load_texture_from_png(data_path("resource/textures/submit_point_icon.png"), false, false); });

Load<Sprite> ui_select_ship(LoadTagDefault, []() -> Sprite const *
                            { return load_texture_from_png(data_path("resource/textures/ui_select_ship.png"), false, false); });

// ============= SCENE AND MESH =============
Load<MeshBuffer> prototype_scene_meshes(LoadTagDefault, []() -> MeshBuffer const *
                                        {
	MeshBuffer const *ret = new MeshBuffer(data_path("resource/scene/prototype_scene.pnct"));
...
Load<Scene> prototype_scene(LoadTagDefault, []() -> Scene const *
    ...
    return new Scene(data_path("resource/scene/prototype.scene"), on_drawable); });

// ============= IMAGE AND TEXT =============
Load<UIRenderer> renderer_gui(LoadTagDefault, []() -> UIRenderer const *
                              {
	UIRenderer *ret = new UIRenderer(data_path("resource/font/DejaVuSans.ttf").c_str(), 16);
    ret->init(1280, 720,
...
Load<UIRenderer> renderer_radar(LoadTagDefault, []() -> UIRenderer const *
                                {
	UIRenderer *ret = new UIRenderer(data_path("resource/font/DejaVuSans.ttf").c_str(), 24);
    ret->init(1280, 720,
        color_texture_program->program,
        color_texture_program->CLIP_FROM_OBJECT_mat4,
        color_texture_program->Position_vec4,
...
Load<Sound::Sample> Submarine_Moving(LoadTagEarly, []() -> Sound::Sample const *
                                     { return new Sound::Sample(data_path("resource/sound/sub_moving.wav")); });
Load<Sound::Sample> Submarine_Start(LoadTagEarly, []() -> Sound::Sample const *
                                    { return new Sound::Sample(data_path("resource/sound/sub_start.wav")); });
Load<Sound::Sample> Submarine_Stop(LoadTagEarly, []() -> Sound::Sample const *
                                   { return new Sound::Sample(data_path("resource/sound/sub_stop.wav")); });
Load<Sound::Sample> Submarine_Hit(LoadTagEarly, []() -> Sound::Sample const *
                                  { return new Sound::Sample(data_path("resource/sound/sub_hit.wav")); });
Load<Sound::Sample> Submarine_Scan1(LoadTagEarly, []() -> Sound::Sample const *
                                    { return new Sound::Sample(data_path("resource/sound/sub_scan1.wav")); });
Load<Sound::Sample> Submarine_Scan2(LoadTagEarly, []() -> Sound::Sample const *
                                    { return new Sound::Sample(data_path("resource/sound/sub_scan2.wav")); });
